...
LargestNumber::LargestNumber(unordered_set<uint32_t> tiles_in, unordered_map<uint32_t, double> single_die_probabilities_in): 
    ShutTheBox(tiles_in, single_die_probabilities_in, "Largest Number", "../results/largest_number.csv") { 
}
